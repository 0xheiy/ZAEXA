...
/* هر دو مسیر روی همین دو عدد. ⚠️ تنگ‌ترش نکن: بسیاری از کاربرانِ این سایت
   از پشتِ VPN می‌آیند و چند کاربرِ واقعی می‌توانند یک IP خروجیِ مشترک
   داشته باشند؛ ۱۲۰ در دقیقه از مصرفِ واقعی (صفحه تماس‌های /gt را
   سریالایز و کش می‌کند) خیلی بالاتر است ولی از هر سیلی خیلی پایین‌تر. */
const RL_LIMIT = 120;
